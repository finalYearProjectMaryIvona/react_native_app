...
// Load the model when the component is loaded
TFLiteModule.loadModel({
  model: 'model.tflite', // Model file in assets folder
  labels: 'labels.txt',  // (Optional) Labels file in assets folder
}, (err, res) => {
  if (err) {
